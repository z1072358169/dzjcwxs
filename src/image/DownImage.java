...
public class DownImage {
	...
	public static void download(DownImageVo downImageVo) throws Exception {
...
//		String url1 = "http://41.5.253.166:8090/Pics5//illepict/2018/09/27/10/410195010000016240/0220180927102713-340-1.jpg";
		//保存路径
		String savePath = "D://"+"images/" + sbbh + "/" + wfdm + "/";
		//要保存的文件名
//		String filename = "1_" + wfdm + "_" + sbbh + "_" + fxbh + "_" + cph + "_4" +".jpg";
		String filename = wfdm + "_" + sbbh + "_" + fxbh + "_" + cdbh + "_" + cph + ".jpg";
