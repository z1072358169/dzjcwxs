...
public class IntervalVMExample extends Page{
...
//	private String toExamine;
	...
	public String toString() {
		return "IntervalVMExample [sysid=" + sysid + ", JKLX=" + JKLX
				+ ", JKBB=" + JKBB + ", CSID=" + CSID + ", MSGID=" + MSGID
				+ ", WFSJLY=" + WFSJLY + ", HPZL=" + HPZL + ", HPHM=" + HPHM
				+ ", WFDM=" + WFDM + ", CJJGDM=" + CJJGDM + ", SJLY=" + SJLY
				+ ", ZPLX=" + ZPLX + ", CJDBH=" + CJDBH + ", CJDZ=" + CJDZ
				+ ", FXBH=" + FXBH + ", CDBH=" + CDBH + ", URL1=" + URL1
				+ ", URL2=" + URL2 + ", URL3=" + URL3 + ", HPTZTP=" + HPTZTP
				+ ", HPYS=" + HPYS + ", SJSCSJ=" + SJSCSJ + ", SFSH=" + SFSH
				+ ", startTime=" + startTime + ", endTime=" + endTime
				+ ", nowId=" + nowId + ", addcount=" + addcount + ", SBBH="
				+ SBBH + ", HDLQSJ=" + HDLQSJ + ", HDCXSJ=" + HDCXSJ
				+ ", ZJSP=" + ZJSP + ", FZZJSPTP=" + FZZJSPTP + ", CJSJ="
				+ CJSJ + ", area=" + area + ", screenDate=" + screenDate
				+ ", allTotal=" + allTotal + ", pass=" + pass + ", tovoid=" + tovoid
				+ ", userId=" + userId + ", userName=" + userName + ", secId="
				+ secId + ", secName=" + secName + ", illegal_explanation="
				+ illegal_explanation + "]";
	}
